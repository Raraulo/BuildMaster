                    ...
                    <form action="{{ route('projects.store') }}" method="POST">
                        ...
                        <div class="grid grid-cols-1 gap-6">
                            ...
                            <div>
                                ...
                                <input type="text" name="nombre" id="nombre" class="mt-1 block w-full rounded-md border-neutral-300 dark:border-neutral-600 dark:bg-neutral-700 dark:text-white shadow-sm focus:border-primary-500 focus:ring-primary-500 sm:text-sm p-3 border" required>
                            ...
                            <div>
                                ...
                                <textarea name="descripcion" id="descripcion" rows="4" class="mt-1 block w-full rounded-md border-neutral-300 dark:border-neutral-600 dark:bg-neutral-700 dark:text-white shadow-sm focus:border-primary-500 focus:ring-primary-500 sm:text-sm p-3 border"></textarea>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                                ...
                                <div>
                                    ...
                                    <input type="date" name="fecha_inicio" id="fecha_inicio" class="mt-1 block w-full rounded-md border-neutral-300 dark:border-neutral-600 dark:bg-neutral-700 dark:text-white shadow-sm focus:border-primary-500 focus:ring-primary-500 sm:text-sm p-3 border" required>
                                ...
                                <div>
                                    ...
                                    <input type="date" name="fecha_fin" id="fecha_fin" class="mt-1 block w-full rounded-md border-neutral-300 dark:border-neutral-600 dark:bg-neutral-700 dark:text-white shadow-sm focus:border-primary-500 focus:ring-primary-500 sm:text-sm p-3 border" required>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
                                ...
                                <div>
                                    ...
                                    <input type="number" name="presupuesto" id="presupuesto" step="0.01" min="0" class="mt-1 block w-full rounded-md border-neutral-300 dark:border-neutral-600 dark:bg-neutral-700 dark:text-white shadow-sm focus:border-primary-500 focus:ring-primary-500 sm:text-sm p-3 border" required>
                                ...
                                <div>
                                    ...
                                    <input type="number" name="avance" id="avance" min="0" max="100" value="0" class="mt-1 block w-full rounded-md border-neutral-300 dark:border-neutral-600 dark:bg-neutral-700 dark:text-white shadow-sm focus:border-primary-500 focus:ring-primary-500 sm:text-sm p-3 border" required>
